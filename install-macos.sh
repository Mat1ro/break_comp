...
for name in main.py audio_player.py brightness_controller.py stop_hotkey.py assets/farts-8.mp3 assets/poop.webp autostart.py requirements.txt README.md; do
